...
public class Registration {
    ...
    public void insertNewCompetitor(String id, String lName, String fName, int age, String instrument,
            String teacherID) {
    ...
    public static void main(String[] args) {
        ...
        // Remember that each time you execute the given .sql file, the database will be
        // reset.
        ...
        // 1 mark - initializeConnection method must create a connection to the
        // database, may not take in any arguments or return any values
        // Must throw an SQLException if connection cannot be made
        myJDBC.initializeConnection();

        // 2 marks - returns a String of competitors/teachers where each lastName,
        // firstName is on a new line with no new line at the end
        // Must take in a String for the table name and return a String (mark deducted
        // if incorrect)
        ...
        // Six arguments that match the competitor table, no return value (mark deducted
        // if incorrect)
        ...
        // 1 mark - insertion should fail and throw an IllegalArgumentException because
        // the new student's teacher is not already registered in the database
        ...
        // 1 mark - insertion should fail and throw an IllegalArgumentException because
        // the new student is outside of the valid age range
        // Check to make sure the competitor was not added
        try {
        ...
        // Must take in the competitor's id as a String, no return value (mark deducted
        // if incorrect)
        // Check to make sure the competitor was deleted (no need for cascade or error
        // checking within the rest of the database)
        ...
        // 1 mark - must show where all Statement, ResultSet, and Connection objects are
        // closed.
        myJDBC.close();
        System.out.println("------------------------------");
